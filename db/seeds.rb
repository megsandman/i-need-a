...
# Match.create(name:"The Ice Cream Bar", link: "http://www.yelp.com/biz/the-ice-cream-bar-san-francisco", genre_id:12, neighborhood_id: 4)
...
# (name: "Arlequin", address: "520 Hayes St", link: "http://www.yelp.com/biz/arlequin-cafe-and-food-to-go-san-francisco", neighborhood_id: 5, genre_id:6)
...
# Match.create(name: "Patxi's Pizza", neighborhood_id: 5, genre_id: 15, link: "http://www.yelp.com/biz/patxis-pizza-san-francisco-2", address: "511 Hayes St")
...
# Match.create(name: "Wrecking Ball Coffee Roasters", neighborhood_id: 7, genre_id: 3, link: "http://www.yelp.com/biz/wrecking-ball-coffee-roasters-san-francisco-2", address: "2271 Union St")
...
# Match.create(name:"Le Marais Bakery", link: "http://www.yelp.com/biz/le-marais-san-francisco", genre_id:12, neighborhood_id: 7)
 # Match.create(name: "SusieCakes", link:"http://www.yelp.com/biz/susiecakes-san-francisco", address:"2109 Chestnut St", neighborhood_id:7, genre_id:"12")
...
# Match.create(name: "Lucca Delicatessen", link:"http://www.yelp.com/biz/lucca-delicatessen-san-francisco", genre_id:14, neighborhood_id:7, address:"2120 Chestnut St")
...
# Match.create(name:"Humphry Slocombe", link:"http://www.yelp.com/biz/humphry-slocombe-ice-cream-san-francisco", genre_id:12, neighborhood_id:8, address:"2790A Harrison St")
# Match.create(name:"Commonwealth", link:"http://www.yelp.com/biz/commonwealth-san-francisco", genre_id:13, neighborhood_id:8, address:"2224 Mission St")
